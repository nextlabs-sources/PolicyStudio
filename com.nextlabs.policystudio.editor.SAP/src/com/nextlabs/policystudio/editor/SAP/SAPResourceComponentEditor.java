...
/**
 * confession: I copy from PortalComponentEditor. Should move those code to BaseComponentEditor
 * 
 */
public class SAPResourceComponentEditor implements IComponentEditor {
    ...
    protected SAPCompositionControl compControl = null;
    ...
    protected void initializeMembers() {
        ...
        compControl = new SAPCompositionControl(membersComposite, SWT.NONE,
    ...
    public SAPResourceComponentEditor(IClientEditorPanel panel,
    ...
    protected String getMemberLabel() {
        return com.nextlabs.policystudio.editor.SAP.EditorMessages.OBJECTCOMPONENTEDITOR_OBJECTS;
    }
    ...
    public String getObjectTypeLabelText() {
        return com.nextlabs.policystudio.editor.SAP.EditorMessages.OBJECTCOMPONENTEDITOR_OBJECT_COMPONENTS;
    }
    ...
    protected String getLookupLabel() {
        return com.nextlabs.policystudio.editor.SAP.EditorMessages.OBJECTCOMPONENTEDITOR_LOOKUP;
    }
    ...
    protected void initializePropertyExpressions() {
        {
            ...
            Composite propertiesLabel = panel.initializeSectionHeading(
                    propertiesComposite,
                    com.bluejungle.destiny.policymanager.editor.EditorMessages.COMPONENTEDITOR_WITH_PROPERTIES);
            FormData data = new FormData();
    		data.left = new FormAttachment(0,EditorPanel.SIDE_SPACING);
            ...
            propertiesNameLabel
                    .setText(com.bluejungle.destiny.policymanager.editor.EditorMessages.COMPONENTEDITOR_PROPERTY_NAME);
        ...
        Composite propertiesLabel = panel.initializeSectionHeading(
                propertiesComposite, com.bluejungle.destiny.policymanager.editor.EditorMessages.COMPONENTEDITOR_WITH_CONTENT);
        FormData data = new FormData();
        data.left = new FormAttachment(0,EditorPanel.SIDE_SPACING);
        ...
        propertiesNameLabel = new Label(propertiesComposite, SWT.NONE);
        propertiesNameLabel.setText(com.bluejungle.destiny.policymanager.editor.EditorMessages.COMPONENTEDITOR_PROPERTY_NAME);
        propertiesNameLabel.setBackground(panel.getBackground());
        data = new FormData();
        data.left = new FormAttachment(0, 65);
        data.top = new FormAttachment(propertiesLabel, EditorPanel.SPACING);
    ...
    private void createNewButton() {
        ...
        buttonAdd.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                String value = null;
                if (internal.equals(com.bluejungle.destiny.policymanager.editor.EditorMessages.COMPONENTEDITOR_CONTENT_TYPE)) {
                    value = getEnumDisplayValues(descriptor)[0];
                } else if (internal
                        .equals(com.bluejungle.destiny.policymanager.editor.EditorMessages.COMPONENTEDITOR_CONTAINS_CONTENT)) {
        ...
        if (panel.isEditable()) {
            ...
            comboPropertyName.addSelectionListener(new SelectionAdapter() {
                ...
                public void widgetSelected(SelectionEvent e) {
                    ...
                    if (!oldValue.equals(newValue)) {
                        ...
                        if (internal
                                .equals(com.bluejungle.destiny.policymanager.editor.EditorMessages.COMPONENTEDITOR_CONTENT_TYPE)) {
            ...
            if (internal.equals(com.bluejungle.destiny.policymanager.editor.EditorMessages.COMPONENTEDITOR_CONTENT_TYPE)) {
                ...
                combo.addSelectionListener(new SelectionAdapter() {
                    ...
                    .equals(com.bluejungle.destiny.policymanager.editor.EditorMessages.COMPONENTEDITOR_CONTAINS_CONTENT)) {
                if (value1.equals(com.bluejungle.destiny.policymanager.editor.EditorMessages.COMPONENTEDITOR_KEYWORDS)) {
                ...
                label.setText(com.bluejungle.destiny.policymanager.editor.EditorMessages.COMPONENTEDITOR_MATCH_COUNT);
            ...
            if (internal.equals(com.bluejungle.destiny.policymanager.editor.EditorMessages.COMPONENTEDITOR_CONTENT_TYPE)) {
                ...
                labelValue.setText(com.bluejungle.destiny.policymanager.editor.EditorMessages.COMPONENTEDITOR_MATCH_COUNT
                        + getValue3(value));
            }
        }
    }
    ...
    private void preparePropertiesList() {
        Collection<AttributeDescriptor> attributes = PolicyServerProxy
                .getAttributes(EntityType.RESOURCE);
        ...
        for (AttributeDescriptor attribute : attributes) {
            ...
            if (group != null
                    && group.equals(com.bluejungle.destiny.policymanager.editor.EditorMessages.COMPONENTEDITOR_WITH_CONTENT)
                    && (internal.equals(com.bluejungle.destiny.policymanager.editor.EditorMessages.COMPONENTEDITOR_CONTENT_TYPE) || internal
                            .equals(com.bluejungle.destiny.policymanager.editor.EditorMessages.COMPONENTEDITOR_CONTAINS_CONTENT))) {
    ...
    private String[] getOperators(AttributeDescriptor descriptor) {
        if (descriptor.getPqlName().equals(
                com.bluejungle.destiny.policymanager.editor.EditorMessages.COMPONENTEDITOR_CONTENT_TYPE)) {
    ...
    private String getValue1(String str) {
        if (str.startsWith("*KEY:")) {
            return com.bluejungle.destiny.policymanager.editor.EditorMessages.COMPONENTEDITOR_KEYWORDS;
    ...
    private String constructContent(String display, String key, int count) {
        String result = "*";
        if (display.equals(com.bluejungle.destiny.policymanager.editor.EditorMessages.COMPONENTEDITOR_KEYWORDS)) {
            result += "KEY:";
            result += key;
        } else {
            result += "REG:";
