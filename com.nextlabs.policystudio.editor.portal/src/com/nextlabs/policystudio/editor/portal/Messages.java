...
public class Messages extends NLS {
	...
	static {
		initializeMessages(
				"com.nextlabs.policystudio.editor.portal.messages",
				Messages.class);
	}
	...
	public static String SERVERLISTPANEL_SERVER_TITLE,
			SERVERLISTPANEL_SERVER_MSG, SERVERLISTPANEL_SERVER_NAME;
	...
	public static String COMPONENTEDITOR_WITH_CONTENT,
			COMPONENTEDITOR_CONTENT_TYPE, COMPONENTEDITOR_CONTAINS_CONTENT,
			COMPONENTEDITOR_KEYWORDS, COMPONENTEDITOR_MATCH_COUNT,
			COMPONENTEDITOR_MEMBERS, COMPONENTEDITOR_WITH_PROPERTIES,
			COMPONENTEDITOR_PROPERTY_NAME;
