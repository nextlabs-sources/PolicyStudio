 ...
 * reserved worldwide.
 */
package com.nextlabs.policystudio.readonly.devicecontrol;
...
public class DeviceControlPolicyDetailsComposite extends
		CommonPolicyDetailsComposite {
	public DeviceControlPolicyDetailsComposite(Composite parent, int style,
			IDPolicy policy) {
	...
	private void diaplaySubjects() {
		...
		// List<CompositePredicate> applicationList =
		// filterPredicate(applications);
	...
	private void displayPolicyName() {
		...
		labelPolicyName.setText(getPolicyName() + " [Device Control Policy]");
		data = new GridData(GridData.FILL_HORIZONTAL);
