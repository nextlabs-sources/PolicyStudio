 ...
 * reserved worldwide.
 */
package com.nextlabs.policystudio.readonly.document;
...
public class DocumentPolicyDetailsComposite extends
		CommonPolicyDetailsComposite {
	public DocumentPolicyDetailsComposite(Composite parent, int style,
			IDPolicy policy) {
