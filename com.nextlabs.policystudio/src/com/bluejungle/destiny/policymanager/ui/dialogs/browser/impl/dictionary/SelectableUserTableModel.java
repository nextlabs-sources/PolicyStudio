...
/**
 * {@see
 * com.bluejungle.destiny.policymanager.ui.dialogs.browser.impl.userbrowser.
 * ISelectableDictionaryBasedLeafObjectTableModel} implementation for User
 * Subjects
 * 
 * @author sgoldstein
 * @version $Id:
 ...
 *          /SelectableUserTableModel.java#1 $
 */

public class SelectableUserTableModel implements
		ISelectableLeafObjectTableModel {

	private static final List<String> COLUMN_HEADERS = new ArrayList<String>(2);
	static {
		COLUMN_HEADERS.add(BrowserMessages.SELECTABLEUSERTABLEMODEL_NAME);
		COLUMN_HEADERS.add(BrowserMessages.SELECTABLEUSERTABLEMODEL_ID);
	}
	...
	public String getTitle() {
		return BrowserMessages.SELECTABLEUSERTABLEMODEL_USERS;
	}
	...
	public boolean supportsLeafObject(LeafObject leafObject) {
		...
		return leafObject.getType() == LeafObjectType.USER;
	}
